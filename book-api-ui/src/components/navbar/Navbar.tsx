...
function Navbar() {
  ...
  return (
    <nav className="bg-black text-white shadow-md fixed w-full">
      ...
      {isOpen && (
        <div className="md:hidden bg-black p-3">
          ...
          <Link to={'/add-book'} className="block px-4 py-2 hover:bg-blue-500">
            Add books
          </Link>
          {/* <Link to={"/about"} className="block px-4 py-2 hover:bg-blue-500">
            About
          </Link> */}
          {/* <button className="text-left px-4 py-2 mt-2 ms-4 bg-white text-blue-600 rounded-lg hover:bg-gray-200">
            Login
          </button> */}
        </div>
      )}
